...
export function orderFulfillment(row, shippingMethod = "twoDay") {
...
export function suggestedRetail(productCost, months, consultCost, fulfillmentRetail = PRICING_MODEL.shipping.twoDay.retail) {
...
export function enrichPricing(row) {
    ...
    plans[consult] = Object.fromEntries(
      PRICING_MODEL.supplyMonths.map((months) => [
        months,
        {
          ...
          suggested_retail: suggestedRetail(product.amount, months, cost, twoDay.shippingRetail + twoDay.processingFee),
  ...
  return {
    ...
    pricing: {
      ...
      fulfillment: {
        shipping_method: twoDay.shippingMethod,
        shipping_cost: twoDay.shippingCost,
        shipping_retail: twoDay.shippingRetail,
        processing_fee: twoDay.processingFee,
        syringes_and_alcohol_pads_included: twoDay.suppliesIncluded,
      },
      plans,
    },
  };
